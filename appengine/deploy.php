<?php
	...
	if ($f=='admin' || $f=='rest' || $f=='kosciol' ||$f=='edit' ||$f=='html' || $f=='o-projekcie' || $f=='mapa' || $f=='konkurs' || $f=='dbg' || $f=='moja' || $f=='kosciol-dbg' || $f=='dary' || $f=='vc' || $f=='pp' || $f=='online' || $f=='live') continue;
    ...
    $cmd="cd $dest; gcloud app deploy app.yaml --project kiedymsza";
